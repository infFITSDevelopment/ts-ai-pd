    ;(function ($) {
      ...
      customCSS.href =
        window.location.port === "5500"
          ...
          : "https://cdn.jsdelivr.net/gh/lmybs112/ts-iframe@1.0.18/css/iframe_ai_pd_style.css";
    ...
    <style media="screen and (min-width: 355px) and (max-width: 479px)">
      ...
      `;
        ...
        const iframeElement = document.getElementById("inffits_tryon_window");
        if (iframeElement) {
          ...
          iframeElement.onload = () => {
            if (window.location.port === "5500") {
              ...
              const id = prompt("請輸入 ID：", "JERSCY_All");
              const brand = prompt("請輸入品牌名稱：", "JERSCY");
